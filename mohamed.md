...
Ce schéma ASCII montre l'ensemble du workflow détaillé pour ce laboratoire, depuis la création et l'exécution du crawler jusqu'à l'interrogation des données avec Athena et la gestion des résultats dans des buckets S3. 
